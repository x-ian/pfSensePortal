...
/usr/bin/perl -I /usr/local/lib/perl5/site_perl/5.10.1/ -I /usr/local/lib/perl5/site_perl/5.10.1/mach $BASEDIR/send_gmail_with_attachment.perl "$SUBJECT" $FILE $FILE application/html "$BODY" "$GMAIL_SENDER" "$GMAIL_SENDER_PASSWD" "$RECEIVER"
