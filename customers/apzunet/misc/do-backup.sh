...
mv radius-complete.tgz /home/local_backups/
...
mv radius-no-authacct-$DATE.tgz /home/local_backups/
...
perl -I /usr/local/lib/perl5/site_perl/5.10.1/ -I /usr/local/lib/perl5/site_perl/5.10.1/mach $BASEDIR/send_gmail.perl "$SUBJECT" "$BODY `cat $TMP_LOGFILE`" "$GMAIL_SENDER" "$GMAIL_SENDER_PASSWD" "$RECEIVER"
rm $TMP_LOGFILE
