...
# a quarterly crontab like should work: 30 3 1 */3 * /home/marsPortal/quarterly_user_cleanup.sh
...
/usr/bin/perl -I /usr/local/lib/perl5/site_perl/5.10.1/ -I /usr/local/lib/perl5/site_perl/5.10.1/mach $BASEDIR/send_gmail_after_quarterly_cleanup.perl `date +%Y%m%d-%H%M` `echo "(mail generated by script pfSense:///home/marsPortal/quarterly_user_cleanup.sh)`
